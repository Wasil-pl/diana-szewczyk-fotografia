export const TEXT_CONTENT = {
  newBorn: {
    ...
    text: [
      ...
      `Zapraszam Cię do doświadczenia tej niesamowitej podróży w krainę magii i uroku, gdzie Twoje dziecko staje się główną gwiazdą.`,
      `Sesja noworodkowa to nie tylko fotografie, to opowieść pełna miłości i emocji, którą będziesz mogła/mógł podziwiać przez lata.`,
    ],
    infoAboutSession: [
    ...
    infoPrice: [
      `15 zdjęć wydrukowanych 15x23 i do pobrania w formie elektronicznej`,
      `każde dodatkowe zdjęcie 35zł`,
      `czas trwania sesji 3-4 godz.`,
    ],
    price: 650,
  },
};
